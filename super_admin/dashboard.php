...
try {
    ...
    $total_licencias_activas = $stmt->fetch(PDO::FETCH_ASSOC)['total'];
    
    // Total de licencias expiradas
    $stmt = $conn->query("SELECT COUNT(*) as total FROM licencias WHERE estado = 'Expirada'");
    $total_licencias_expiradas = $stmt->fetch(PDO::FETCH_ASSOC)['total'];
    
    // Total de usuarios
    $stmt = $conn->query("SELECT COUNT(*) as total FROM usuarios WHERE rol = 2");
    ...
    $stmt = $conn->query("SELECT id, nombre FROM empresa ORDER BY id DESC LIMIT 5");
                                    ...
                                    <table class="table table-striped table-sm">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="empresas_ver.php?id=<?php echo $empresa['id']; ?>" class="btn btn-sm btn-info">
                                                        <i class="bi bi-eye"></i>
                                                    </a>
                                                    <a href="empresas_editar.php?id=<?php echo $empresa['id']; ?>" class="btn btn-sm btn-warning">
