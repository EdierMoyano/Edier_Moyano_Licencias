...
if (isset($_GET['activar']) && !empty($_GET['activar'])) {
    ...
    try {
        ...
        $stmt = $conn->prepare("UPDATE licencias SET estado = 'Activa' WHERE id = ?");
...
} elseif (isset($_GET['desactivar']) && !empty($_GET['desactivar'])) {
    ...
    try {
        ...
        $stmt = $conn->prepare("UPDATE licencias SET estado = 'Inactiva' WHERE id = ?");
...
try {
    ...
    if (!empty($busqueda)) {
        $where[] = "(l.codigo_licencia LIKE ? OR e.nombre LIKE ?)";
        $params[] = "%$busqueda%";
        $params[] = "%$busqueda%";
    }
    ...
    $stmt = $conn->prepare("SELECT COUNT(*) FROM licencias l 
                           LEFT JOIN tipo_licencia tl ON l.id_tipo_licencia = tl.id 
                           LEFT JOIN empresa e ON l.id_empresa = e.id 
                           $whereClause");
    $stmt->execute($params);
    ...
    $stmt = $conn->prepare("SELECT l.*, tl.nombre as tipo_nombre, e.nombre as empresa_nombre, 
    ...
    $stmt = $conn->query("SELECT id, nombre FROM tipo_licencia ORDER BY nombre");
                        ...
                        <form action="" method="GET" class="row g-3">
                            <div class="col-md-3">
                                ...
                                <select class="form-select" id="tipo" name="tipo">
                                    ...
                                    <option value="<?php echo $tipo['id']; ?>" <?php echo (isset($_GET['tipo']) && $_GET['tipo'] == $tipo['id']) ? 'selected' : ''; ?>>
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-select" id="empresa" name="empresa">
                                    ...
                                    <option value="<?php echo $empresa['id']; ?>" <?php echo (isset($_GET['empresa']) && $_GET['empresa'] == $empresa['id']) ? 'selected' : ''; ?>>
                                ...
                                <tbody>
                                    <?php if (count($licencias) > 0): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="empresas_ver.php?id=<?php echo $licencia['id_empresa']; ?>">
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <a href="licencias.php?activar=<?php echo $licencia['id']; ?>" class="btn btn-sm btn-success" title="Activar licencia">
                                                        <i class="bi bi-check-lg"></i>
                                                    </a>
                                                    <?php elseif ($licencia['estado'] == 'Activa'): ?>
                                                    <a href="licencias.php?desactivar=<?php echo $licencia['id']; ?>" class="btn btn-sm btn-warning" title="Desactivar licencia">
