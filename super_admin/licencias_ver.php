...
try {
    ...
    $stmt = $conn->prepare("SELECT COUNT(*) FROM usuarios WHERE id_empresa = ?");
    $stmt->execute([$licencia['id_empresa']]);
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    ...
                    <div class="btn-toolbar mb-2 mb-md-0">
                        <div class="btn-group me-2">
                            <a href="licencias_editar.php?id=<?php echo $id; ?>" class="btn btn-sm btn-outline-warning">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="?id=<?php echo $id; ?>&cambiar_estado=Activa">Marcar como Activa</a></li>
                                <li><a class="dropdown-item" href="?id=<?php echo $id; ?>&cambiar_estado=Inactiva">Marcar como Inactiva</a></li>
                                <li><a class="dropdown-item" href="?id=<?php echo $id; ?>&cambiar_estado=Expirada">Marcar como Expirada</a></li>
                            </ul>
                        </div>
                    ...
                    <div class="col-md-8">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <p><strong>ID:</strong> <?php echo $licencia['id']; ?></p>
                                        <p><strong>Empresa:</strong> <a href="empresas_ver.php?id=<?php echo $licencia['id_empresa']; ?>"><?php echo htmlspecialchars($licencia['empresa_nombre']); ?></a></p>
                                    ...
                                    <div class="col-md-6">
                                        <p><strong>Fecha de Inicio:</strong> <?php echo date('d/m/Y', strtotime($licencia['fecha_inicio'])); ?></p>
                                        <p><strong>Fecha de Fin:</strong> <?php echo date('d/m/Y', strtotime($licencia['fecha_fin'])); ?></p>
                                        <p><strong>Fecha de Compra:</strong> <?php echo date('d/m/Y H:i', strtotime($licencia['fecha_compra'])); ?></p>
                                        <p>
                                ...
                                <?php if (!empty($licencia['tipo_licencia_descripcion'])): ?>
                                <div class="alert alert-info">
                                    <h6 class="alert-heading">Descripción del Tipo de Licencia:</h6>
                                    <p class="mb-0"><?php echo nl2br(htmlspecialchars($licencia['tipo_licencia_descripcion'])); ?></p>
                                </div>
                                <?php endif; ?>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-grid gap-2">
                                    <a href="empresas_ver.php?id=<?php echo $licencia['id_empresa']; ?>" class="btn btn-primary">
                                        <i class="bi bi-building"></i> Ver Empresa
                                    </a>
                                    <a href="licencias_crear.php?empresa=<?php echo $licencia['id_empresa']; ?>" class="btn btn-outline-success">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-grid">
                                    <a href="usuarios.php?empresa=<?php echo $licencia['id_empresa']; ?>" class="btn btn-outline-info">
