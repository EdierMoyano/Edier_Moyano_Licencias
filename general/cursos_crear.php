...
$descripcion = '';
$f_inicio = date('Y-m-d');
$f_fin = date('Y-m-d', strtotime('+7 days'));
$lugar = '';
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($errores)) {
        try {
            ...
            // Insertar curso
            $stmt = $conn->prepare("INSERT INTO cursos (nombre, descripcion, f_inicio, f_fin, lugar, id_creador) VALUES (?, ?, ?, ?, ?, ?)");
            $stmt->execute([$nombre, $descripcion, $f_inicio, $f_fin, $lugar, $_SESSION['user_id']]);
            ...
            header("Location: cursos_ver.php?id=$id_curso&mensaje=creado");
            exit;
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="bi bi-book-fill me-1"></i> Formulario de Curso
                    </div>
                    <div class="card-body">
                        <form method="post" action="">
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                <a href="cursos.php" class="btn btn-secondary me-md-2">Cancelar</a>
